	...
	*/
	...
	$wp_customize->add_control( new gltheme_Text_Control(
		...
		array(
			...
			<p><a style="font-size: 14px;color: #ffffff;font-weight: 600;background-color: #51d2cb;border: 3px solid #51d2cb;border-radius: 5px;padding: 5px;text-decoration: none" href="https://doc.ltheme.com/free-elementor-onepage-wordpress-theme-document/" target="_blank" title="Read full theme document">Documentation</a>
			<a style="font-size: 14px;color: #ffffff;font-weight: 600;background-color: #40c6cc;border: 3px solid #40c6cc;border-radius: 5px;padding: 5px;text-decoration: none" href="https://ltheme.com/free-one-page-wordpress-themes/" target="_blank" title="See other beauty Wordpress themes from us">See Other Themes</a></p>
	...
	border-radius: 5px;
	padding: 5px;text-decoration: none;" href="https://ltheme.com/project/lt-swim-onepage-free-swimming-school-wordpress-theme/" target="_blank" title="Get full website like demo with PRO version">' . __( 'Get PRO License', 'gltheme' ) . '</a>
