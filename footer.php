    ...
    <!-- /End Footer -->
		<footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="site-info container">
			    ...
			    <div class="lt-footer">
			        <p>
	      				<a href="https://ltheme.com/wordpress-themes/" target="_blank" title="" rel="author nofollow">Premium Wordpress theme</a> by <a href="https://ltheme.com/" target="_blank" title="Wordpress themes" rel="author nofollow">LTheme</a>
					</p>
			    </div>
			</div><!-- .site-info -->
		</footer><!-- .site-footer -->
